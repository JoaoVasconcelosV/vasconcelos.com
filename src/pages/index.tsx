  ...
  return (
    <div> 
      ...
      <div className='bk-image text-white flex items-center justify-center flex-col h-screen'>
        ...
        <button className='bg-black m-3 p-2 rounded-lg hover:bg-backgroundColor2 hover:text-blue'>Download CV</button>
      </div>
      <div id='about' className='min-h-screen flex flex-col items-center m-10 text-center'>
        <h1>About</h1>
        <div className="flex inline flex-col xl:flex-row sm:justify-center sm:items-center m-auto mx-20 2xl:mx-96 flex-1">
      ...
      <div id='projects' className='min:h-screen bg-backgroundColor2 flex flex-col items-center pt-10 text-center'>
        <h1>Projects</h1>
      ...
      <div id='skills' className='h-screen flex flex-col items-center pt-10 text-center'>
        <h1>Skills</h1>
        <div className='flex flex-1 flex-wrap mx-20 2xl:mx-80 items-center justify-center'>
          <LoadingBar title="HTML" image="/html_icon.svg" concluded={30}/>
          <LoadingBar title="CSS" image="/css_icon.svg" concluded={90}/>
          <LoadingBar title="JavaScript" image="/js_icon.svg" concluded={100}/>
          <LoadingBar title="ReactJS" image="/react_icon.svg" concluded={50}/>
        </div>
      </div>
      <div id='timeline' className='h-screen bg-backgroundColor2 flex flex-col items-center pt-10'>
        <h1>Timeline</h1>
        <Timeline />
      </div>
    </div>
